...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("G:\\PracticeProject\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("lzq");
        ...
        dsc.setUrl("jdbc:mysql://192.168.48.131:3306/gmall_" + moduleName + "?useUnicode=true&useSSL=false&characterEncoding=utf8");
